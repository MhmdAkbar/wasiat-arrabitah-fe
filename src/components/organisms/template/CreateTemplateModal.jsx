...
import FieldBuilder from "@/components/organisms/template/FieldBuilder";
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden border-t-4 border-mosque-gold">
        ...
        >
          ...
          <div className="flex justify-end gap-3 p-4 border-t border-gray-100 bg-white shrink-0">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 text-sm font-bold text-white bg-mosque-dark hover:bg-mosque-primary rounded-lg transition flex items-center gap-2 shadow-md"
            >
