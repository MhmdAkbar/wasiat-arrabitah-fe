        ...
        <form onSubmit={handleWorkflowSubmit} className="p-6">
          ...
          <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-100">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2 text-sm font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition"
            >
              {t("template.cancel")}
            </button>
            <button
              ...
              className="px-5 py-2 text-sm font-bold text-white bg-mosque-dark hover:bg-mosque-primary rounded-lg transition flex items-center gap-2"
            >
              <i className="fa-solid fa-check-double"></i>{" "}
              {t("template.save_workflow")}
            </button>
          </div>
        </form>
      </div>
