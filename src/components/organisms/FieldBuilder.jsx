...
export default function FieldBuilder({ fields, onAdd, onRemove, onChange }) {
  ...
  return (
    <div>
      ...
      <button type="button" onClick={onAdd} className="mt-4 text-sm font-semibold text-mosque-primary hover:text-mosque-dark flex items-center gap-2 px-2 py-1 rounded hover:bg-mosque-light transition">
