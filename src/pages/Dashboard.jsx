...
import { useDashboard } from '../hooks/useDashboard'; // Import Custom Hook
...
export default function Dashboard() {
  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-soft border border-gray-100">
      <h4 className="text-lg font-bold text-gray-800 mb-1">{t('dashboard.test_api_title')}</h4>
      <p className="text-sm text-gray-500 mb-6">{t('dashboard.test_api_desc')}</p>
